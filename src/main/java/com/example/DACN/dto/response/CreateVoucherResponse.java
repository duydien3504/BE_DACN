...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Response after creating a voucher")
public class CreateVoucherResponse {
    ...
    @Schema(description = "Creation timestamp", example = "2025-12-31T09:00:00")
    private LocalDateTime createdAt;

    @Schema(description = "Success message", example = "Voucher created successfully")
